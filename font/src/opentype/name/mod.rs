...
impl NameTable {
  ...
  fn parse_string_offset(data: &[u8]) -> u16 {
    BigEndian::read_u16(&data[Self::STRING_OFFSET_OFFSET..Self::STRING_OFFSET_OFFSET+U16_LENGTH])
  }
...
impl NameRecord {
  ...
  fn parse_encoding(data: &[u8]) -> Result<Encoding, ParseError> {
    ...
    let encoding_id = BigEndian::read_u16(&data[Self::ENCODING_ID_OFFSET..Self::ENCODING_ID_OFFSET+U16_LENGTH]);
  ...
  fn parse_string_length(data: &[u8]) -> u16 {
    BigEndian::read_u16(&data[Self::STRING_LENGTH_OFFSET..Self::STRING_LENGTH_OFFSET+U16_LENGTH])
  }

  fn parse_string_offset(data: &[u8]) -> usize {
    BigEndian::read_u16(&data[Self::STRING_OFFSET_OFFSET..Self::STRING_OFFSET_OFFSET+U16_LENGTH]) as usize
  }
}
